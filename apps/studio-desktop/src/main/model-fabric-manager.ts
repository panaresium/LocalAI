...
const SEED_MODELS: readonly SeedModel[] = [
  ...
  },
  {
    ...
    model: "gemma4:31b",
    label: "Gemma 4 31B",
    roles: ["orchestrator.primary", "agent.general", "agent.deep", "agent.summarize", "vision.general", "vision.document", "image.verify"],
    lifecycle: "exclusive",
    contextLength: 128000,
    capabilities: ["text", "vision", "multimodal", "reasoning", "local", "latest-june-2026"],
    parameterCountB: 31,
    marketplaceRank: 1,
    recommendedTaskProfileIds: ["conversation", "knowledge-research", "creative-media"],
    sourceUrl: "https://ollama.com/library/gemma4:31b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: false,
    enabled: true,
    local: true,
    notes: "Latest June 2026 flagship local multimodal model; use on systems with enough memory."
  },
  {
    ...
    model: "qwen3.6:35b",
    label: "Qwen3.6 35B",
    roles: ["orchestrator.primary", "agent.general", "agent.deep", "agent.code", "agent.verify", "translation.quality"],
    lifecycle: "exclusive",
    contextLength: 262144,
    capabilities: ["text", "reasoning", "code", "agentic", "local", "latest-june-2026"],
    parameterCountB: 35,
    marketplaceRank: 2,
    recommendedTaskProfileIds: ["code-change", "knowledge-research", "conversation"],
    sourceUrl: "https://ollama.com/library/qwen3.6:35b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: false,
    enabled: true,
    local: true,
    notes: "Latest June 2026 high-capability reasoning, coding, and agentic local model."
  },
  {
    ...
    model: "gemma4:26b",
    label: "Gemma 4 26B",
    roles: ["agent.general", "agent.deep", "agent.summarize", "vision.general", "vision.document", "image.verify"],
    lifecycle: "exclusive",
    contextLength: 128000,
    capabilities: ["text", "vision", "multimodal", "mixture-of-experts", "local", "latest-june-2026"],
    parameterCountB: 26,
    marketplaceRank: 3,
    recommendedTaskProfileIds: ["conversation", "knowledge-research", "creative-media"],
    sourceUrl: "https://ollama.com/library/gemma4:26b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: false,
    enabled: true,
    local: true,
    notes: "Latest June 2026 multimodal local model with large total capacity and lower active compute."
  },
  {
    ...
    lifecycle: "exclusive",
    contextLength: 262144,
    capabilities: ["text", "reasoning", "code", "multilingual", "local", "latest-june-2026"],
    parameterCountB: 27,
    marketplaceRank: 4,
    recommendedTaskProfileIds: ["code-change", "knowledge-research", "conversation"],
    ...
    enabled: true,
    local: true,
    notes: "Latest June 2026 capable local reasoning and coding model."
  },
  {
    id: "ollama:mistral-small3.2:24b",
    providerId: "ollama",
    model: "mistral-small3.2:24b",
    label: "Mistral Small 3.2 24B",
    roles: ["agent.general", "agent.deep", "agent.code", "vision.general", "vision.document", "agent.verify"],
    lifecycle: "exclusive",
    contextLength: 128000,
    capabilities: ["text", "vision", "code", "multilingual", "local", "latest-june-2026"],
    parameterCountB: 24,
    marketplaceRank: 5,
    recommendedTaskProfileIds: ["conversation", "code-change", "knowledge-research", "creative-media"],
    sourceUrl: "https://ollama.com/library/mistral-small3.2:24b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: false,
    enabled: true,
    local: true,
    notes: "June 2025 24B multimodal model still among the strongest efficient local choices in the catalog."
  },
  {
    ...
    model: "gpt-oss:20b",
    label: "GPT-OSS 20B",
    roles: ["agent.general", "agent.deep", "agent.code", "agent.verify", "agent.summarize"],
    lifecycle: "warm",
    contextLength: 128000,
    capabilities: ["text", "reasoning", "tool-use", "code", "local", "latest-june-2026"],
    parameterCountB: 20,
    marketplaceRank: 6,
    recommendedTaskProfileIds: ["conversation", "code-change", "knowledge-research"],
    ...
    enabled: true,
    local: true,
    notes: "Latest open-weight GPT-style local model for reasoning, tool use, and coding."
  },
  {
    ...
    roles: ["agent.code", "agent.verify", "agent.deep"],
    lifecycle: "exclusive",
    contextLength: 262144,
    capabilities: ["text", "code", "agentic", "local", "latest-june-2026"],
    ...
    enabled: true,
    local: true,
    notes: "Latest coding-focused local model for complex implementation tasks; large download."
  },
  {
    ...
    lifecycle: "on-demand",
    contextLength: 128000,
    capabilities: ["text", "vision", "multimodal", "local", "latest-june-2026"],
    parameterCountB: 12,
    marketplaceRank: 8,
    recommendedTaskProfileIds: ["conversation", "knowledge-research", "creative-media"],
    sourceUrl: "https://ollama.com/library/gemma4:12b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: false,
    enabled: true,
    local: true,
    notes: "Latest compact multimodal Gemma 4 model for balanced local usage."
  },
  {
    ...
    model: "gemma4:e4b",
    label: "Gemma 4 E4B",
    roles: ["controller.fast", "agent.general", "agent.summarize", "vision.general"],
    lifecycle: "pinned",
    contextLength: 32768,
    capabilities: ["text", "vision", "efficient", "mixture-of-experts", "local", "latest-june-2026"],
    parameterCountB: 4.5,
    marketplaceRank: 9,
    recommendedTaskProfileIds: ["conversation", "computer-control", "creative-media"],
    sourceUrl: "https://ollama.com/library/gemma4:e4b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: true,
    enabled: true,
    local: true,
    notes: "Latest efficient Gemma 4 model for always-warm local controller and quick multimodal tasks."
  },
  {
    ...
    model: "gemma4:e2b",
    label: "Gemma 4 E2B",
    roles: ["controller.fast", "agent.general", "agent.summarize"],
    lifecycle: "pinned",
    contextLength: 32768,
    capabilities: ["text", "efficient", "mixture-of-experts", "local", "latest-june-2026"],
    parameterCountB: 2.3,
    marketplaceRank: 10,
    recommendedTaskProfileIds: ["conversation", "computer-control"],
    sourceUrl: "https://ollama.com/library/gemma4:e2b",
    runtimeKind: "ollama",
    downloadSupported: true,
    preloadRecommended: true,
    enabled: true,
    local: true,
    notes: "Latest very efficient Gemma 4 model for low-memory local routing."
  },
  {
